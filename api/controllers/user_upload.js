...
export const createUserUpload = (req, res) => {
  const q =
    'INSERT INTO UserUpload (user_id, file_name, file_path) VALUES (?, ?, ?)'
...
export const updateUserUpload = (req, res) => {
  const q =
    'UPDATE UserUpload SET user_id = ?, file_name = ?, file_path = ? WHERE id = ?'
